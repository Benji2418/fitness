...
export const exercises = [
  ...
  },
  {
    ...
    image: require('../assets/exercise_icon_gifs/incline_dumbbell_row.gif'),
    muscles: ["Middle Back"],
    equipment: ["Dumbbell"],
  },
  {
    ...
    image: require('../assets/exercise_icon_gifs/incline_barbell_row.gif'),
    muscles: ["Middle Back"],
    equipment: ["Barbell"],
  },
  {
    ...
    image: require('../assets/exercise_icon_gifs/seated_row_machine.gif'),
    muscles: ["Middle Back"],
    equipment: ["Machine"],
  },
  {
  ...
  {
    id: 22,
    title: "Lever High Row",
    image: require('../assets/exercise_icon_gifs/lever_high_row.gif'),
    muscles: ["Lats"],
    equipment: ["Machine"],
  },
  {
  ...
  {
    id: 31,
    title: "Dumbbell Preacher Bicep Curl",
    image: require('../assets/exercise_icon_gifs/dumbbell_preacher_curl.gif'),
    muscles: ["Biceps"],
    equipment: ["Dumbbell"],
  },
  {
    id: 32,
    title: "Dumbbell One-Arm Preacher Bicep Curl",
    image: require('../assets/exercise_icon_gifs/dumbbell_one_arm_preacher_curl.gif'),
    muscles: ["Biceps"],
    equipment: ["Dumbbell"],
  },
  {
    id: 33,
    title: "Lever Preacher Bicep Curl",
    image: require('../assets/exercise_icon_gifs/lever_preacher_curl.gif'),
    muscles: ["Biceps"],
    equipment: ["Machine"],
  },
  {
  ...
  },
  {
    id: 41,
    title: "Hack Squat",
    image: require('../assets/exercise_icon_gifs/hack_squat.gif'),
  ...
  {
    id: 44,
    title: "Smith Machine Barbell Hip Thrust",
    image: require('../assets/exercise_icon_gifs/smith_machine_barbell_hip_thrust.gif'),
    muscles: ["Glutes", "Core", "Hamstrings", "Calves"],
  ...
  },
  {
    ...
    image: require('../assets/exercise_icon_gifs/barbell_deadlift.gif'),
    muscles: ["Quadriceps", "Hamstrings", "Glutes", "Calves", "Lower Back"],
    equipment: ["Barbell"],
  },
  {
    id: 49,
    title: "Dumbbell Deadlift",
    image: require('../assets/exercise_icon_gifs/dumbbell_deadlift.gif'),
    muscles: ["Quadriceps", "Hamstrings", "Glutes", "Calves", "Lower Back"],
    equipment: ["Dumbbell"],
  },
  {
  ...
  {
    id: 55,
    title: "Weighted Neck Harness Flexion",
    image: require('../assets/exercise_icon_gifs/weighted_neck_harness_flexion.gif'),
    muscles: ["Neck"],
    equipment: ["Harness"],
  },
  {
    id: 56,
    title: "Weighted Neck Harness Extension",
    image: require('../assets/exercise_icon_gifs/weighted_neck_harness_extension.gif'),
    muscles: ["Neck"],
    equipment: ["Harness"],
  },
  {
    id: 57,
    title: "Lying Plate Neck Flexion",
    image: require('../assets/exercise_icon_gifs/plate_lying_neck_flexion.gif'),
    muscles: ["Neck"],
    equipment: ["Plate"],
  },
  {
    id: 58,
    title: "Lying Plate Neck Extension",
    image: require('../assets/exercise_icon_gifs/plate_lying_neck_extension.gif'),
    muscles: ["Neck"],
    equipment: ["Plate"],
  },
  {
  ...
  },
  {
    ...
    muscles: ["Middle Back", "Quadriceps", "Hamstrings"],
    equipment: ["Cardio"],
  },
  // {
  //   id: 39,
